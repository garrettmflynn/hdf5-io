      ...
      //globals are not declared by default in browser scripts, these files are function scopes!
          ...
          if(typeof globalThis['HDF5IO'] !== 'undefined') 
            Object.assign(globalThis['HDF5IO'],bundle); //we can keep assigning the same namespaces more module objects without error!
          else 
            globalThis['HDF5IO'] = bundle;
